...
const column = createColumnHelper<datapelanggan>();
      ...
      h("div", { class: "d-flex gap-2" }, [
        ...
        h(
          "button",
          {
            ...
            onClick: () =>
              deletedatapelanggan(`/datapelanggan/${cell.getValue()}`),
          },
...
<template>
  ...
  <div class="card">
    <div class="card-header align-items-center">
      <h2 class="mb-0">List Data Pelanggan</h2>
      <button
        type="button"
