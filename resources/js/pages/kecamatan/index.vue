...
const { delete: forceDeleteKecamatan} = useDelete({
        ...
        cell: (cell) =>
            h("div", { class: "d-flex gap-2" }, [
                h("button", {
                    ...
                    title: "Restore",
                    onClick: () =>
                        restoreKecamatan(`/kecamatan/${cell.getValue()}/restore`),
                }, h("i", { class: "la la-undo fs-2" })),
                h("button", {
                    class: "btn btn-sm btn-icon btn-danger",
                    title: "Hapus Permanen",
                    onClick: () =>
                        forceDeleteKecamatan(`/kecamatan/${cell.getValue()}/force-delete`),
                }, h("i", { class: "la la-trash fs-2" })),
            ]),
    }),
];
    ...
    <div class="card border-danger">
        <div class="card-header align-items-center">
            <h2 class="mb-0 text-danger">
                kecamatan <small>(data yang telah dihapus)</small>
            </h2>
        </div>
        <div class="card-body">
            <paginate
                ref="trashRef"
                id="table-kecamatan_trash"
                url="/kecamatan/trash"
